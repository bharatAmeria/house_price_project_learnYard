...
from src.connection.mongo_conn import MongoDBClient
    ...
    def export_collection_as_dataframe(self) -> pd.DataFrame:
        ...
        try:
            ...
            if database_name is None:
                collection = self.mongo_client.database[CONFIG["COLLECTION_NAME"]]
            else:
                collection = self.mongo_client[database_name][CONFIG["COLLECTION_NAME"]]
